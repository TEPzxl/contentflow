...
test -f ".github/workflows/release-images.yaml"
grep -q "Build and push backend" ".github/workflows/release-images.yaml"
grep -q "Build and push frontend" ".github/workflows/release-images.yaml"
